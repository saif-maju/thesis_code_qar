...
test_file = os.path.join("data", "squad", "test.jsonl")
...
flags.DEFINE_integer("num_steps", 6000, "Number of steps")
flags.DEFINE_integer("checkpoint", 100, "checkpoint for evaluation")
flags.DEFINE_integer("period", 10, "period to save batch loss")
flags.DEFINE_integer("val_num_batches", 90, "Num of batches for evaluation")
